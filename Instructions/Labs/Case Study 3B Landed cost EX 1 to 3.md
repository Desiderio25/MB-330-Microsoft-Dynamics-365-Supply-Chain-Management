...
6. On the **Costing** FastTab, set **Posting specification** to **Total**.
    - **Total** – A total figure is posted to the ledger.
    - **Item group** – The adjustment is specified per item group.
    - **Item number** – The adjustment is specified per item. This value provides the most detail.
...
7. In the **Shipping company** field, select **1002**. Available values may vary by environment. If **1002** isn't available, select any available option.

8. Select **OK**.

### Add a purchase order to a staging list

1. Expand the **Data generation criteria**.

2. In the **Setup name** field, select **Inquiry**.

3. If no data is available select **Generate data**.

4. On the **Inbound orders** FastTab, select the first two purchase orders. 

5. On the **Lines to select** FastTab, select the checkbox for each purchase order line that you want to include in the new shipping container.

6. On the **Lines to select** FastTab, on the toolbar, select **Add to staging list**.

### Add a staging list to a shipping container

1. On the toolbar, select **View staging list**.

  The **Add staging list to shipping container** page opens. The purchase order lines that you selected are listed on the **Lines in staging list** FastTab. All the purchase order lines in this list will be added to the shipping container that you create. You can remove any line by selecting it and then selecting **Remove line** on the toolbar of the FastTab.

2. On the **Lines in staging list** FastTab, on the toolbar, select **Add to a new shipping container**.

3. In the **Shipping container** field, select **ECMU4657496** or the available shipping container.

4. In the **Journey template** field, select **AUMEL-AKLNZ** or the available journey template.
...
6. In the **From port** field, select **USALB**.

7. In the **To port** field, select **CNSHA**.

8. On the **Lines** FastTab, select **+ Add**.

9. In the **Cost type code** field, select **Air**. If **Air** is not available, select any available option instead.
